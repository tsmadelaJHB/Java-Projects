...
public class Sprint extends CommandHandler{
    /**
     * Generate the sprint request object
    ...
    public static JSONObject sprintJSON(String command, Robot robot) {
        ...
        try {
            ...
            generateErrorMessage(result, "Please enter '<sprint> <number of steps>'.");
        }
