package za.co.wethinkcode.claims.app.db;

import com.google.common.collect.ImmutableList;
import za.co.wethinkcode.claims.app.db.memory.MemoryDb;
...
public interface DataRepository {
    ...
    double getTotalUnsettledClaimsClaimedFrom(String email);
    ...
    List<Claim> findUnsettledClaimsClaimedFrom(String email);
     ...
     * @return A non-null (but possibly empty) Set of Claims.
     */
    List<Claim> findSettledClaimsClaimedFrom(String email);
     ...
     * @return A non-null (but possibly empty) Set of Claims.
     */
    List<Claim> findUnsettledClaimsClaimedBy(String email);
     ...
     * @return A non-null (but possibly empty) Set of Claims.
     */
    List<Claim> findSettledClaimsClaimedBy(String email);

    /**
     * Answer the (money) total of all unsettled Claims claimed BY a given Person.
     * @param email A Person who owes zero or more Claims. May not be {@literal null}.
     * @return The total of all Claim amounts owed by the given Person.
     */
    double getTotalUnsettledClaimsClaimedBy( String email);
