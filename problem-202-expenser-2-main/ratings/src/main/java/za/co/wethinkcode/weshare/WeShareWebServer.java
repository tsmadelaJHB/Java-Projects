...
import za.co.wethinkcode.weshare.ratings.RatingsViewController;
...
//            settlementRoutes();
    ...
    private void ratingsPage() {
        path(RatingsViewController.PATH, () -> get(RatingsViewController::renderRatingsPage));
    }
